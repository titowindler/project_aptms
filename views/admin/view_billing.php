        ...
        <div class="content-wrapper"> 
            ...
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                  <div class="d-flex">
                    <i class="mdi mdi-cash-multiple menu-icon"></i>
                    <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Billing</p>
          ...
          <div class="row">
            <div class="col-md-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">View Billing List</p>
                    <hr>
                    <p class="card-description text-left">
                      <!-- Button trigger modal -->
                       <!--  <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal"> Add Billing </button> -->
                     </p>
                  <div class="table-responsive">
                    <table id="viewBillingList" class="table">
                      <thead>
                        <tr>
                            <th>Bill ID</th>
                            <th>Date</th>
                     ...
                     <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal1"> View Record </button>
                      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal1"> Print List </button>
                  </div>
                </div>
              </div>
            </div>
