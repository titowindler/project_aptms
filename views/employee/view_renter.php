            ...
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                  <div class="d-flex">
                    <i class="mdi mdi-houzz menu-icon"></i>
                    <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Renters</p>       
                  </div>
                </div>
              </div>
            </div>
...
<!-- Modal -->
<div class="modal fade" id="addRenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
