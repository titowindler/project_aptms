...
$sqlEmployee = "INSERT INTO employee (`employee_id`,`employee_username`,`employee_password`,`employee_name`,`employee_contactno`,`assign_branch`,`employee_status`,`employee_bool`) VALUES (NULL,'$employee_username','$convert_employee_password','$convert_employee_name','$employee_contactnum',$assign_branch,'$employee_status','$employee_bool')";
...
$sqlEmployeeDetails = "INSERT INTO employee_details (`employee_detail_id`,`employee_picture`,`employee_description`) VALUES ('$last_id','$employee_picture','$employee_description')";
...
if($resultEmployeeDetails == TRUE) {
  header('location:../views/admin/view_employee.php');
} else {
